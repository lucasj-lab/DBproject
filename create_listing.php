...
<>
    ...
    <script>
        ...
        function updateCities() {
            ...
            cityInput.value = "";
            cityInput.style.display = "none"; // Hide the text input by default
        ...
        // Function to toggle input visibility based on city dropdown selection
        function clearDropdown() {
            const cityDropdown = document.getElementById('city-dropdown');
            const cityInput = document.getElementById('city-input');

            if (cityDropdown.value === "") {
                cityInput.style.display = "block"; // Show the text input
            } else {
                cityInput.style.display = "none"; // Hide the text input if a city is selected
            }
        }

        // Attach clearDropdown function to cityDropdown change event
        document.getElementById('city-dropdown').addEventListener('change', clearDropdown);
    </script>
</body>
