        ...
        <?php if (!empty($listings)): ?>
            <div class="listings-container">
                <?php foreach ($listings as $listing): ?>
                    ...
                    $formattedDate = $datePosted->format('l, F jS, Y, g:i A'); // Example format: "Friday, November 1st, 2024, 5:00 PM"
                    ?>
                    <form class="listing-item" action="listing_details.php" method="GET">
                        ...
                        <p>Posted on: <?php echo htmlspecialchars($formattedDate); ?></p> <!-- Display formatted date -->
